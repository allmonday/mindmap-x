...
const zh = {
  ...
  'help.hold': '长按（约半秒）',
  'help.holdD': '激活节点——亮出操作按钮行（加子 / 加备注 / 聚焦 / 删除）；带备注的节点同时打开备注面板',
  'help.dragOn': '拖到节点上',
  ...
  'help.del': '删除子树',
  'help.delD': '删除节点及整个子树（按钮行的删除有两步确认，快捷键直删）',
  'help.secNav': '导航',
  'help.navV': '同层流动',
  ...
  'help.esc': '逐层退出',
  'help.escD': '跳转面板 → 弹窗 → 备注面板 → 退出聚焦',
  'help.secView': '面板与视图',
  'help.note': '备注面板',
  'help.noteD': '左侧面板开关；橙色 #N 角标直开；图钉常驻',
  'help.crumb': '面包屑（聚焦时）',
  'help.crumbD': '点击切换聚焦层级；悬停中间项弹出同层兄弟快速跳转',
...
const en: Record<I18nKey, string> = {
  ...
  'help.holdD': 'Activate — shows the action bar (add child / note / focus / delete); opens the note panel if the node has one',
  ...
  'help.delD': 'Removes the node and its whole subtree (button-row delete has a two-step confirm; the shortcut deletes immediately)',
  ...
  'help.escD': 'Palette → dialogs → note panel → leave focus',
  ...
  'help.crumbD': 'Click to switch focus level; hover a middle crumb for sibling quick-jump',
